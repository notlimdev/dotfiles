...
BORDER_WIDTH="3" P_FADE="true" P_SHADOWS="true" P_CORNER_R="6" SHADOW_C="#000000"

# Colorscheme
bg="#0E1113" fg="#afb1db"

black="#353c52" red="#DA103F" green="#1EB980" yellow="#FFCC57"
blackb="#353c52" redb="#F43E5C" greenb="#07DA8C" yellowb="#F77D26"
