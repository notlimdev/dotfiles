...
-- Save current file guardar
map("n", "<leader>w", ":w<cr>", { desc = "Save file", remap = true })


-- Guardar archivo con Ctrl + S en modo normal y de inserción
map("n", "<C-s>", ":w<cr>", { desc = "Save file with Ctrl + S" })
map("i", "<C-s>", "<esc>:w<cr>a", { desc = "Save file with Ctrl + S in insert mode" })
